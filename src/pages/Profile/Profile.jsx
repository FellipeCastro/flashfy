...
const Profile = ({ isSidebarOpen, setIsSidebarOpen }) => {
    ...
    const validateForm = () => {
        ...
        if (isEditing) {
            const hasAnyPassword = userData.currentPassword || userData.newPassword || userData.confirmPassword;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Adicionar dados de senha apenas se fornecidos
            ...
            setErrors({
                general: error.response?.data?.error || "Erro ao atualizar perfil"
            });
        } finally {
            setIsLoading(false);
        }
