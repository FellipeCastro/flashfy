...
import { RiRobot2Fill, RiLightbulbFlashLine } from "react-icons/ri";
                    ...
                    aiResponse.questions.length === 0 && (
                        <div className={styles.tips}>
                            ...
                            <ul className={styles.tipsList}>
                                <li>
                                    Seja específico no tema (ex: "Fotossíntese"
                                    em vez de "Biologia")
                                </li>
                                <li>
                                ...
                                <li>
                                    Use temas que você está estudando atualmente
                                </li>
                            </ul>
                        </div>
                    )}
                {isLoading && (
                    <div className={styles.loadingState}>
                        ...
                        <p className={styles.loadingDescription}>
                            Suas questões estão sendo geradas pela inteligência
                            artificual, aguarde alguns instantes!
                        </p>
                    </div>
                )}
            </div>
